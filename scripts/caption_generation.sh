...
export CACHE_DIR=./cache # --> TODO: change the cache dir
export IMAGE_TOKEN
...
for model_name in "gpt" "gemini"; do #"llava"
    for retriever_name in "BLIP_FF" "CLIP_SF"; do
        ...
        for params in "1 fewshot_rag" "5 fewshot_rag" "1 fewshot_random" "5 fewshot_random"; do
            ...
            for ((i = 0; i < $image_count; i += $bs)); do
                ...
                CUDA_VISIBLE_DEVICES=6 python ./src/unirag/caption_generation_inference.py \
